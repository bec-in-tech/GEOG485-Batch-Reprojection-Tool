#-------------------------------------------------------------------------------
# Name:        Reproject Data in Folder
# Project:     Lesson 2 Project 2
...
try:
    ...
    targetFolder = r'C:\PSU\Geog485_FA23\Lesson2Project\Lesson2'
    targetFC =  r'C:\PSU\Geog485_FA23\Lesson2Project\Lesson2\CountyLines.shp'
    ...
    for featureClass in fcList:
        ...
        if featureClassSR.Name != targetSR.Name:
            ...
            # If the name properties match, skip the reprojection
            continue
